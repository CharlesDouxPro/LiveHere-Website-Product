        ...
        <div class="d-flex flex-row content-center">
          <div class="flex-fill">
            ...
            <div class="d-flex flex-row align-items-center">
              ...
              <span class="ml-10">{{ modality.students.stu_first_name }} {{ modality.students.stu_last_name }}</span>
            </div>
          </div>
          <i class="icon-class">
            <img src="@/assets/icons/cancel-icons.svg" alt="icon" class="icon-class" @click="delModality(modality.mod_id)" />
          </i>
        </div>
      </div>
    </div>
